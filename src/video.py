"""Analyse temporelle d'une courte vidéo d'animal.

On extrait quelques frames avec OpenCV, on localise l'animal avec MediaPipe,
on calcule des métriques de mouvement, puis on décrit les frames clés avec le
LLM Vision pour construire un résumé utilisable par le RAG.
"""
