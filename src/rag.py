"""Pipeline RAG : retrieval depuis ChromaDB + génération par LLM (Groq).

Inclut depuis v4 :
- Analyse comportementale (texte)
- Détection structurée d'émotion (Pydantic)
- Adaptation par race (optionnelle)

Usage :
    py -m src.rag    # lance un test rapide
"""
...
# =====================================================================
# MODÈLE PYDANTIC POUR L'ANALYSE D'ÉMOTION
# =====================================================================
...
# =====================================================================
# MODÈLE PYDANTIC POUR L'ANALYSE SANTÉ / URGENCE
# =====================================================================
